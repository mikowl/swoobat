...
const PokemonList3: React.FC = () => {
  ...
  return (
    <div>
      {isInitialLoading ? (
        <div role="status"> <svg aria-hidden="true" className="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-400 fill-yellow-200" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
